...
export type FacadeFinish='shop'|'office'|'urban-shop'|'urban-office'|'ribbon-a'|'curtain-b'|'curtain-b-roof'|'streamline-c'|'streamline-c-roof';
...
export function facadeColors(finish:FacadeFinish,palette:Palette){
  ...
  if(finish==='curtain-b')return {wall:'#a5a49c',frame:'#ddd7c7',metal:'#958977',glass:['#887b68','#7f7868','#8c806b'][tone],masonry:false};
