...
export const SCENARIOS: readonly ScenarioDefinition[] = [
  ...
  },
  {
    id: 'merge-500-500',
    name: 'Merge 500 + 500',
    description: '위·아래 두 입구의 동일 규모 흐름이 하나의 목표로 합류하는 공정성과 처리량을 확인합니다.',
    goal: { x: 1090, y: 360 },
    obstacles: [],
    ...
    flows: [
      {
        id: 'upper',
        spawn: { x: 70, y: 105, width: 300, height: 205 },
        goal: { x: 1090, y: 360 },
      },
      {
        id: 'lower',
        spawn: { x: 70, y: 410, width: 300, height: 205 },
        goal: { x: 1090, y: 360 },
      },
    ],
    flowControl: {
  ...
  },
  {
    ...
    description: '같은 통로에서 정반대 목표를 가진 두 흐름의 차선 형성과 교착 회피를 확인합니다.',
    goal: { x: 1090, y: 360 },
    obstacles: [],
    ...
    flows: [
      ...
      {
        id: 'westbound',
        spawn: { x: 830, y: 245, width: 310, height: 230 },
        goal: { x: 90, y: 360 },
      },
    ],
    flowControl: {
  ...
  },
  {
    ...
    description: '수평·수직 500 Agent 흐름이 중앙 교차부를 공유할 때의 연속 처리량을 확인합니다.',
    goal: { x: 1110, y: 360 },
    obstacles: [],
    ...
    flows: [
      ...
      {
        id: 'southbound',
        spawn: { x: 500, y: 35, width: 200, height: 300 },
        goal: { x: 600, y: 685 },
      },
    ],
    flowControl: {
